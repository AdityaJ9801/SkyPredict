...
model_pre = pickle.load(open("./models/xgb1.pkl", "rb"))
print("Model Loaded")
...
def create_gemini_prompt(latitude, longitude, crop_type, soil_type, area, current_temperature, humidity, rain_today, month, day):
    return (
...
def predict_rainfall(temp, wind_speed, hourly_humidity, rain_today, month, day):
    ...
    prediction = model_pre.predict([input_lst])[0]
...
def main():
    with Prediction:
        ...
        # Customizing the layout of the map
            ...
            prompt_text = create_gemini_prompt(latitude, longitude, crop_type, soil_type, area, current_temperature, hourly_humidity, rain_today, month, day)
